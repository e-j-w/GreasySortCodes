...
#define EGamma_no90deg_mca_SMOL_cxx
#include "common.h"
#include "EGamma_no90deg_mca_SMOL.h"
...
int main(int argc, char **argv){
  ...
  if((argc != 3)&&(argc != 4)){
    cout << "Generates TIGRESS mca spectra without 90 degree detectors." << endl;
    cout << "Arguments: EGamma_no90deg_mca_SMOL smol_file output_file keV_per_bin" << endl;
