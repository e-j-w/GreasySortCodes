...
TH2F *trifEdE;
TH2F *trifE_chan, *trif_hitmap, *trif_BAD_hitmap, *trif_GOOD_hitmap, *trif_proj_YZ, *trif_proj_XZ, *trif_single_hitmap, *trif_braggE_detNum, *trifdEdx_Range, *trifdEdx_Range_interp_simple, *trifdEdx_Range_interp_complex, *trifE_chan_cut;
TH3F *trif_3D_hitmap;
