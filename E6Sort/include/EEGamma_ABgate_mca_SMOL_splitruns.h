#ifndef EEGamma_ABgate_mca_SMOL_splitruns_h
#define EEGamma_ABgate_mca_SMOL_splitruns_h
...
//spectra
double mcaOut[MAX_NUM_GATES][MAX_NUM_SUBSETS][SP_ENUM_LENGTH][S32K]; //output .dmca data
