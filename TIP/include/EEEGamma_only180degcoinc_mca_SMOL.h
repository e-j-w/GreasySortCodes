#ifndef EEEGamma_only180degcoinc_mca_SMOL_h
#define EEEGamma_only180degcoinc_mca_SMOL_h
...
class EEEGamma_only180degcoinc_mca_SMOL{
	public :

		EEEGamma_only180degcoinc_mca_SMOL(){;}
