...
# SumAllHist.sh, original author S. Gillespie
# Sums all histograms from the specified runs.  This should not be run by itself, instead it is called as part of SumRunHist.sh.
