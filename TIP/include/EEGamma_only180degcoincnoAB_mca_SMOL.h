#ifndef EEGamma_only180degcoincnoAB_mca_SMOL_h
#define EEGamma_only180degcoincnoAB_mca_SMOL_h
...
class EEGamma_only180degcoincnoAB_mca_SMOL{
	public :

		EEGamma_only180degcoincnoAB_mca_SMOL(){;}
