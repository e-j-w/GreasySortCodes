...
void SortDiagnosticsS::Initialise() {
  ...
  tigE_tigE = new TH2F("TIGRESS_Gamma_Gamma", "TIGRESS Gamma-Gamma", 4096, 0, 8192, 4096, 0, 8192);
  ...
  tigE_tigE_tsep = new TH2F("TIGRESS_Gamma_Gamma_tsep", "TIGRESS Gamma-Gamma time separated", 4096, 0, 8192, 4096, 0, 8192);
  ...
  tigE_tigE_tsepmult2 = new TH2F("TIGRESS_Gamma_Gamma_tsepmult2", "TIGRESS Gamma-Gamma time separated multiplicity 2", 4096, 0, 8192, 4096, 0, 8192);
