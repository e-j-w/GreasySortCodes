...
//     TVector3 gridnormal=TTrific::fNormalGridVec;
 ...
 ///////// THESE PARAMETER ESTIMATES NEED TUNING TO THE DATA SET ///////// 
    ...
    TH2F* rangeZ=new TH2F("rangeZ","Range vs dE/dx peak;Range [cm];de/dx peak [arb.]",200,20,40,500,0,100000);
    TH2F* rangeZextra=new TH2F("rangeZextra","Range vs dE/dx peak Full Fit;Range [cm];de/dx peak [arb.]",200,20,40,500,0,100000);
  

	fflush(stdout);
    // Loop over events
    int nentries = DataChain->GetEntries();
